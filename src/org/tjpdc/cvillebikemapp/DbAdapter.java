...
public class DbAdapter {
	...
	public static final String K_TRIP_WEATHER = "weather";
	public static final String K_TRIP_PURP = "purpose";
	...
	private static final String TABLE_CREATE_TRIPS = "create table trips "
			+ "(_id integer primary key autoincrement, weather text, purpose text, start double, endtime double, "
	...
	public boolean addCoordToTrip(long tripid, AccuracyPoint pt) {
	 ...
	 * indicate failure.
	 */
	public long createTrip(String weather, String purpose, double starttime,
			String fancystart, String note) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(K_TRIP_WEATHER, weather);
		initialValues.put(K_TRIP_PURP, purpose);
	...
	public Cursor fetchAllTrips() {
		Cursor c = mDb.query(DATA_TABLE_TRIPS, new String[] { K_TRIP_ROWID,
				K_TRIP_WEATHER, K_TRIP_PURP, K_TRIP_START, K_TRIP_FANCYSTART,
				K_TRIP_NOTE, K_TRIP_FANCYINFO }, null, null, null, null, "-"
				+ K_TRIP_START);
	...
	public Cursor fetchTrip(long rowId) throws SQLException {
		Cursor mCursor = mDb.query(true, DATA_TABLE_TRIPS, new String[] {
				K_TRIP_ROWID, K_TRIP_WEATHER, K_TRIP_PURP, K_TRIP_START,
				K_TRIP_FANCYSTART, K_TRIP_NOTE, K_TRIP_LATHI, K_TRIP_LATLO,
				K_TRIP_LGTHI, K_TRIP_LGTLO, K_TRIP_STATUS, K_TRIP_END,
	...
	public boolean updateTrip(long tripid, String weather, String purpose,
			double starttime, String fancystart, String fancyinfo, String note,
			int lathigh, int latlow, int lgthigh, int lgtlow, float distance) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(K_TRIP_WEATHER, weather);
		initialValues.put(K_TRIP_PURP, purpose);
		initialValues.put(K_TRIP_START, starttime);
